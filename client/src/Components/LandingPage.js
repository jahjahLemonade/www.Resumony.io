...
const LandingPage = () => { 
    return ( 
        <div className='max-w-[2200px]'>
            ...
            <div className='lg:flex lg:justify-between lg:items-center lg:px-10 mt-16 mb-24 | xl:px-40 | 2xl:px-60'>
                <img src={harmony} alt='lady' className='w-full h-50 text-center mb-12 | md:h-72 md:mb-8 | lg:max-w-[400px] lg:order-last | xl:h-[400px] | 2xl:max-w-[800px] 2xl:h-[450px] 2xl:pl-20'/>
                    <div className='flex flex-col h-[420px] justify-center lg:max-w-[620px] | xl:justify-around'>
                        ...
                        <div className='flex justify-center px-4 | lg:justify-start lg:px-0'><button className='rounded-lg w-full max-w-[400px] lg:text-md h-16 bg-blue-700 text-slate-50 mb-8 | lg:w-[250px]'>Get Started</button></div>
                    </div>
            </div>
            <div className='w-full bg-blue-100 mb-8 p-4 flex flex-col items-center'>
                <h1 className='text-2xl font-semibold text-center text-blue-700 mb-4 mt-8'>We’ve helped job seekers secure jobs at top companies</h1>
            ...
            <div>
                <h1 className='text-center text-xl font-semibold text-blue-700'>Features</h1>
                <p className='text-center text-md font-light mb-8'>Explore our platform’s top features</p>
            </div>
            <div className='px-4 | md:flex md:flex-col md:items-center | lg:px-10 lg:flex-row | md:justify-center'>
                {/* 3 cards */}
                <div className='flex flex-col justify-center items-center w-full h-[400px] shadow-sm rounded-lg bg-[#f9fafb] px-2 | md:max-w-[350px]'>
                   <div className='w-full max-w-'><img src={featureOne} alt='f2' className='w-full h-full' /></div>
                ...
                <div className='flex flex-col justify-center items-center w-full h-[400px] shadow-sm rounded-lg bg-[#f9fafb] my-8 px-2| md:max-w-[350px] lg:my-0 lg:mx-4 | xl:mx-10'>
            ...
            <div className='flex flex-col justify-center items-center w-full h-[300px] bg-blue-100 px-2 my-8'>
                <h1 className='text-3xl text-center font-semibold text-blue-700 mt-8'>Unlock Your Career Potential!</h1>
                <p className='max-w-[1000px] text-md text-center font-light my-8'>Experience our advanced AI Resume Tool first-hand. Get exclusive perks and help shape our product with your feedback. Join us – no spam, no personal info selling. Just pure career enhancement!</p>             
                <Link to='/signup' className='flex justify-center items-center text-lg rounded-lg w-full max-w-[400px] h-12 bg-blue-700 text-slate-50 mb-8 | lg:w-[250px]'>Join now</Link>
            </div>
            <div className='my-8'>
                <h1 className='text-center text-xl font-semibold text-blue-700'>Testimonials</h1>
            ...
            <div className='px-4 | lg:flex lg:justify-center'>
                {/* 3 cards */}
                <div className='flex flex-col shadow-md rounded-lg justify-around items-center w-full h-72 bg-slate-50 text-center p-4 | lg:max-w-[300px] | xl:max-w-[350px]'>
                    ...
                    <p className='font-semibold text-blue-700'>Jonathan</p>
                </div>
                <div className='flex flex-col shadow-md rounded-lg justify-around items-center w-full h-72 bg-slate-50 text-center my-8 p-4 | lg:max-w-[300px] lg:my-0 lg:mx-4 | xl:max-w-[350px] xl:mx-10'>
                    <img src={rating} alt='rating' className='w-36 h-8' />
                    ...
                    <p className='font-semibold text-blue-700'>Charlotte</p>
                </div>
                <div className='flex flex-col shadow-md rounded-lg justify-around items-center w-full h-72 bg-slate-50 text-center p-4 mb-16 | lg:max-w-[300px] | xl:max-w-[350px]'>
                    <img src={rating} alt='rating' className='w-36 h-8' />
                    ...
                    <p className='font-semibold text-blue-700'>Paul</p>
                </div>
            </div>
            {/* FAQ
            <div className='my-8'>
                <h1 className='text-center text-xl font-semibold text-blue-700'>FAQ</h1>
            ...
            {/* Footer */}
            <div className='w-full h-16 bg-blue-700 flex justify-center items-center'>
