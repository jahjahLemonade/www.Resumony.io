...
const Signout = () => {
  ...
  return (
    <nav className='border border-slate-300 flex justify-between items-center p-2 sm:p-4 | xl:px-20'>
      ...
      <div className='flex'>
      <Link className='flex justify-center items-center w-24 h-8 rounded-md border-2 border-blue-700 text-blue-700 mr-2 | md:w-28 md:h-12 | xl:mr-8' to='/feedback'>Feedback</Link>
